...
public class ConfigBuilder {
    ...
    private void handlerPackage(TemplateConfig template, String outputDir, PackageConfig config) {
        ...
        if (null != configPathInfo) {
            ...
            setPathInfo(pathInfo, template.getXml(), idea ? outputDir.replace("java","resources") : outputDir, ConstVal.XML_PATH, ConstVal.XML);
                ...
                while (results.next()) {
                    ...
                    if (StringUtils.isNotBlank(tableName)) {
                        ...
                        if (commentSupported) {
                            ...
                            tableInfo.setComment(tableComment.replace("表",""));
                        }
...
//                    field.setKeyFlag(false);
                    ...
                    String fieldType = results.getString(dbQuery.fieldType());
